...
flight1 = Event.create!(
					...
					start_time: Time.new(2019, 12, 22, 6, 30),
					end_time: Time.new(2019, 12, 22, 7, 45),
					trip: christmas,
					traveler: kyle
					)
...
flight2 = Event.create!(
					...
					start_time: Time.new(2019, 12, 29, 13, 0),
					end_time: Time.new(2019, 12, 29, 14, 15),
					trip: christmas,
					traveler: kyle
					)
...
checkin = Event.create!(
					...
					start_time: Time.new(2019, 12, 22, 15, 00),
					end_time: Time.new(2019, 12, 22, 15, 15),
					trip: paris,
					traveler: sulli
					)
...
denCheckIn = Event.create!(
					...
					start_time: Time.new(2020, 2, 22, 10, 00),
					end_time: Time.new(2020, 2, 22, 11, 00),
					trip: ski2020,
					traveler: perry
					)